...
public class JdbcDisciplineDao extends AbstractCrudDao<Discipline, Long> implements DisciplineDao {
    ...
    public static final String COUNT = "SELECT count(*) FROM discipline";
    public static final String FIND_ALL_BY_IDS = "SELECT id, discipline_name, educator_id FROM discipline WHERE id IN (%s)";
    public static final String DELETE_ALL = "DELETE FROM discipline";
    public static final String DELETE_ALL_BY_IDS = "DELETE FROM discipline WHERE id IN (%s)";
