...
public class JdbcDisciplineDao extends AbstractCrudDao<Discipline, Long> implements DisciplineDao {
    ...
    public JdbcDisciplineDao(JdbcTemplate jdbcTemplate) {
        ...
        this.jdbcInsert = new SimpleJdbcInsert(jdbcTemplate).withTableName("disciplines").usingGeneratedKeyColumns("id");
    }
    ...
    protected Discipline create(Discipline entity) {
        Number id = jdbcInsert.executeAndReturnKey(
                new MapSqlParameterSource()
                        ...
                        .addValue(DISCIPLINE_SPECIALISM_ID, entity.getSpecialismId())
                        .addValue(DISCIPLINE_ACADEMIC_YEAR_ID, entity.getAcademicYearId())
    ...
    protected Discipline update(Discipline entity) {
        if (1 == jdbcTemplate.update(UPDATE, entity.getDisciplineName(), entity.getSpecialismId(),
                entity.getAcademicYearId(), entity.getEducatorId(), entity.getId())) {
            return entity;
        }
