...
class UniversityMigrationTest extends BaseDaoTest {
    ...
    void shouldCreateTables() {
        ...
        Assertions.assertTrue(strings.containsAll(Arrays.asList("weekly_schedule",
                "educator", "discipline", "daily_schedule",
                "educator_specialism", "specialism", "discipline_specialism",
                "lecture", "lecture_number", "room",
                "student", "lecture_student")));
    }
}